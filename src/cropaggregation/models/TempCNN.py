...
# Derived from BreizhCrops; see docs/THIRD_PARTY_NOTICES.md.
# Modified experimental defaults: kernel_size=3, hidden_dims=32, dropout=0.5.
# 2026-09-17: added provenance/license notice; executable code unchanged.
import os
